...
public class MenuController : MonoBehaviour
{
    ...
    Dictionary<MenuStates, BaseMenu> menuDictionary = new Dictionary<MenuStates, BaseMenu>(); // Dictionary to store menu states and their corresponding menu instances for quick access
    ...
    public void JumpBack() // Jumps back to the previous menu in the stack
    {
    ...
    public void JumpTo(MenuStates newState, bool fromJumpBack = false) // fromJumpBack is used to prevent pushing the same menu twice when jumping back
    { 
